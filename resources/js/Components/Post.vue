...
<template>
      <!-- <div id="Post" class="w-full bg-white rounded-lg my-4 shadow-md">
        ...
        <div class="flex items-center py-3 px-3">
         ...
         <button class="mr-2">
            ...
            <img class="rounded-full ml-1 min-w-[42px] max-h-[42px]" src="https://picsum.photos/seed/picsum/200/300" >
      ...
      <div id="Post" class="w-full bg-white rounded-lg my-4 shadow-md">
        ...
        @click="isImageDisplay=post.image"
         class="mx-auto cursor-pointer" :src="post.image">
        <div id="Likes" class="px-5">
            <div class="flex items-center justify-between py-3 border-b">
                <ThumbUp fillColor="#1D72E2" :size="16" @click="likePost"/>
                <!-- <div class="text-sm text-blue-600 font-semibold">{{likes.length}}</div> -->
                <div class="text-sm text-gray-600 font-semibold">{{comments.length}}</div>
            </div>
        </div>
